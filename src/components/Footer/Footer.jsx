const Footer = () => {
  return (
    <div className="mt-12 bg-base-200">
      {/* Main Footer Section */}
      <footer className="max-w-7xl mx-auto footer text-base-content p-10 flex flex-wrap justify-between gap-6">
        <nav className="w-full sm:w-1/2 md:w-auto">
          <h6 className="footer-title text-lg font-semibold text-gray-900 mb-4">Services</h6>
        ...
        <nav className="w-full sm:w-1/2 md:w-auto">
          <h6 className="footer-title text-lg font-semibold text-gray-900 mb-4">Company</h6>
        ...
        <nav className="w-full sm:w-1/2 md:w-auto">
          <h6 className="footer-title text-lg font-semibold text-gray-900 mb-4">Legal</h6>
      ...
      <footer className="footer bg-base-200 text-base-content border-t border-base-300 px-10 py-4 flex flex-col sm:flex-row justify-between items-center">
        <aside className="flex items-center space-x-2">
          ...
          <p className="text-2xl font-bold">
            <span className="text-amber-600">Book</span> <span className="text-cyan-600">Surf</span>
          </p>
        </aside>
